...
This code resizes the images from KITTI dataset by a factor of 0.5 and save it on the training_resized directory
16.5.2018
'''
...
print('size of image {}'.format(resized_image.shape))

# plot rect for every box
for objind in range(len(objects)):
    drawBox2D(resized_image, objects[objind])
