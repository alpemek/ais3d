...
dataset = PartDataset(root = 'shapenetcore_partanno_segmentation_benchmark_v0', classification = False, class_choice = ['Chair','Car','Airplane'])
...
for epoch in range(opt.nepoch):
    for i, data in enumerate(dataloader, 0):
        ...
        print('5. Points{} , Target={} '.format(points.shape,target.shape))
