...
class TestSave(unittest.TestCase):
    ...
    def setUp(self):
        self.p = pcl.load(
            "/home/emeka/Schreibtisch/AIS/ais3d/python-pcl-master/tests/table_scene_mug_stereo_textured_noplane.pcd")
...
class TestExtract(unittest.TestCase):
    ...
    def setUp(self):
        self.p = pcl.load("/home/emeka/Schreibtisch/AIS/ais3d/python-pcl-master/tests/flydracyl.pcd")
